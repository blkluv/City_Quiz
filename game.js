...
let Cities = {
    ...
    NO38_Skien: new Question(new GoogleMapsImage("Kloster%C3%B8ya,Skien,Norway", 13, ["gndyPlQndSZDN6vsWzF939R2Rl0=","_NoD48ObGUMBqkRlpP2e5Ar5vPU="]), "Skien"),
    ...
    NO15_Alesund: new Question(new GoogleMapsImage("Sparebanken%20M%C3%B8re%20Arena,%C3%85lesund,Norway", 12, ["xrp60nyO_4RcVihWefpRGu18ll0=","yNT58LlA3iVxkmHYB4Mg4YJ2PX8="]), "Ålesund", ["ålesund","alesund","aalesund"]),    NO38_Tonsberg: new Question(new GoogleMapsImage("Tr%C3%A6leborg,T%C3%B8nsberg,Norway", 13, ["6uCkT15S_qrC1l7yIDg94Z7NHvw=","zHZzQ-zKFntHAh0XDJ1gMNUQUk8="]), "Tønsberg", ["tønsberg","tonsberg","toensberg"]),
    NO30_Moss: new Question(new GoogleMapsImage("Thornel%C3%B8kka,Moss,Norway", 13, ["kYEamiNAxP68-_ntRNcbEiVzPvc=","6SH-F2OAc9C_dvvszmoodqZcuFk="]), "Moss"),
    ...
    NO18_Bodo: new Question(new GoogleMapsImage("Bod%C3%B8,Norway", 12, ["sAI3prEe1P1Suv1HNN9MDKZxR-Q=","RMrTNoDCpA3cUNxI8rmnBp-IoLE="]), "Bodø", ["bodø","bodo","bodoe"]),
    NO54_Tromso: new Question(new GoogleMapsImage("Troms%C3%B8,Norway", 12, ["V6RRpEWKGrQtfKWQtZeBtpj7iOg=","oD2CMS1CS1BhRW_QedR_p7agFl8="]), "Tromsø", ["tromsø","tromso","tromsoe"]),
    ...
    NO46_Askoy: new Question(new GoogleMapsImage("Kleppest%C3%B8,Norway", 15, ["eJzXXu5Vnc_ZdbQF_g4A1RyL3zo=","w4B7IvrMRG81_azBP-s337bUeUc="]), "Askøy", ["kleppestø","kleppesto","kleppestoe","askøy","askoy","askoey","kleppestø, askøy","kleppesto, askoy","kleppestoe, askoey"]),
    ...
    NO34_Gjovik: new Question(new GoogleMapsImage("Gj%C3%B8vik,Norway", 14, ["w_wSL6tYDI5S7p2HIMyKmivoBjM=","epzu_BGAE2BfvKbsgd2p8qI2KsQ="]), "Gjøvik", ["gjøvik","gjovik","gjoevik"]),
    ...
    USMT_Helena: new Question(new GoogleMapsImage("Helena,MT", 13, ["89xofi06W04xAWzRm_xdMlOzzNU=","ZLBuEANBPXoAr0DSX6twmQ7X87Q="]), "Helena"),
